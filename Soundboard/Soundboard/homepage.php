...
<script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
  ...
  function isPiano()
  {
    ...
    function makePiano()
    {
      for(var i=0;i<500;i++)
      {
        if(typeof audioDatabasePiano.get(i) != 'undefined' && typeof audioDatabaseMap.get(i)!='undefined')
        {
          console.log(audioDatabaseMap);
          console.log(audioDatabasePiano);
          if(audioDatabasePiano.get(i) == 0)
          {
            console.log(0);
            audioMap.set(i, new Audio('Sounds/'+audioDatabaseMap.get(i).toString()+".mp3"));
            //console.log('Sounds/'+audioDatabaseMap.get(i).toString()+".mp4");
            //console.log(audioMap.get(i).getAttribute('src'));
          }
          else
          {
            console.log(1);
            audioMap.set(i, new Audio('Piano Sounds/'+audioDatabaseMap.get(i).toString()+".mp3"))
            //console.log('Piano Sounds/'+audioDatabaseMap.get(i).toString()+".mp4");
            //console.log(audioMap.get(i).getAttribute('src'));
          }
          //console.log(audioMap.get(i).getAttribute('src'));
        }
